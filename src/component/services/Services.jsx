                        ...
                        <ul className="services__modal-services grid">
                            <li className="services__modal-service">
                                <i className="uil uil-check-circle services__modal-icon">
                                    ...
                                    Product designers improve the usability of everyday items by creating new designs
                                    </p>
                                </i>
                            </li>
            ...
            <div className='services__content'>
                ...
                <div className={
                    ...
                    <div className='services__modal-content'>
                        ...
                        <p className='services__modal-description'>
                        Collaborate with marketing, development, 
                        information technology (IT), and operations teams
                        </p>
                        ...
                        <ul className="services__modal-services grid">
                            ...
                            <li className="services__modal-service">
                                <i className="uil uil-check-circle services__modal-icon">
                                    <p className="services__modal-info">
                                    Create and manage data visualization
                                    </p>
                                </i>
                            </li>
